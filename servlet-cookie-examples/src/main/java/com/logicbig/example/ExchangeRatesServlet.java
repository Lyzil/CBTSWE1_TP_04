...
public class ExchangeRatesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Optional<Cookie> op = Optional.empty();

        if (cookies != null) {
            op = Arrays.stream(cookies)
        ...
        if (op.isPresent()) {
            ...
            RequestDispatcher rd =
                    req.getRequestDispatcher("/currencySelection.html");
            rd.forward(req, resp);
        }
    }
    ...
    private static void showCurrencyRate(HttpServletResponse resp, String currencyPair)
        ...
        writer.write("<p><a href='remove-currency-pair'>Remove currency selection</a></p>");

        writer.write("<p><a href='creditos.html'>Creditos</a></p>");
        writer.close();
    }
}